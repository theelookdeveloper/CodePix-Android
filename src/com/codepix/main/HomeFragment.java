...
import com.codepix.model.StaggeredAdapter;
	      ...
	      protected String doInBackground(String... params) {
	            ...
	            //  while(true)
	             // {
	              	...
	              	{	
	              	   try {
						GlobalMethods.doSearchPost(getActivity(),1);
					} catch (Exception e) {
  ...
  @Override
	...
	if (Build.VERSION.SDK_INT < Build.VERSION_CODES.HONEYCOMB) 
		...
		gridView.setOnItemClickListener(new StaggeredGridView.OnItemClickListener() {
		 ...
		 adapter = new StaggeredAdapter(getActivity(), R.id.imageView1, urls,postlist);
